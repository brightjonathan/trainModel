...
if __name__ == "__main__":
    ...
    #The main purpose of a transformer is to understand and generate sequences of data, especially natural language (text), using self-attention to capture the relationships between elements in a sequence — regardless of their distance.